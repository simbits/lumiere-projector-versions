...
# flip horizontally
#i2cset -y 0 0x1b 0x0f 0x00 0x00 0x00 0x01 i
#i2cset -y 0 0x1b 0x10 0x00 0x00 0x00 0x00 i

# set high power
i2cset -y 0 0x1b 0x12 0x00 0x00 0x03 0x84 i
i2cset -y 0 0x1b 0x13 0x00 0x00 0x03 0x84 i
i2cset -y 0 0x1b 0x14 0x00 0x00 0x03 0x84 i
